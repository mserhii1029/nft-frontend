...
import { Box, Button, Container, Menu, MenuItem, Stack, Typography, useMediaQuery } from '@mui/material';
    ...
    >
        ...
        >
                ...
                <Typography
                  sx={
                    location.pathname === '/auction'
                      ? {
                          borderBottom: `2px solid ${darkMode ? '#ffffff' : '#040708'}`,
                        }
                      : null
                  }
                  variant='subtitle1'
          ...
          <Box style={{ display: 'flex', gap: '1rem', marginRight: '2.8rem' }}>
            ...
            {walletAddress ? (
              ...
              >
                <img style={{ width: '20px', height: '20px' }} src={MetaMaskIcon} alt='Meta Mask Icon' />
                <Typography
                  variant='subtitle1'
                  component='span'
                  sx={{
      ...
      {!isMobile ? (
        ...
        >
          ...
          >
            {darkMode ? (
              <img style={{ height: '20px', width: '20px' }} src={MetaMaskIcon} alt='Metamask' />
            ) : (
              <img style={{ height: '20px', width: '20px' }} src={MetaMaskIcon} alt='Metamask' />
            )}
            <Typography variant='body1' color='secondary' sx={{ fontSize: '12px' }}>
